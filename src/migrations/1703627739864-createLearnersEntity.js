class CreateLearnersEntity1703627739864 {
  ...
  async up(queryRunner) {
    ...
    await queryRunner.query(
      `ALTER TABLE "learners" ADD CONSTRAINT "FK_35f025925eefb5717499a11092d" FOREIGN KEY ("vacancyId") REFERENCES "vacancies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "learners" ADD CONSTRAINT "FK_83887ef027645d8c5051d3ebfb0" FOREIGN KEY ("candidateId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
